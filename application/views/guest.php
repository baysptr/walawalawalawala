...
<section class="page-section bg-primary text-white" id="hasil">
	<div class="container">
		...
		<!-- Contact Section Heading -->
		<h2 class="page-section-heading text-center text-white text-uppercase mb-0">Check Data Peminatan</h2><br/><h4 class="text-center">Atas nama: <strong><?= $this->session->userdata('nama') ?></strong></h4>
